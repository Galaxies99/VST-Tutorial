...
Module Info.
  ...
  Definition source_file := "../PL-course/abs.c"%string.
...
Definition _abs : ident := 54%positive.
...
Definition f_abs := {|
  ...
  fn_temps := nil;
  fn_body :=
(Sifthenelse (Ebinop Olt (Etempvar _x tint) (Econst_int (Int.repr 0) tint)
               tint)
  (Sreturn (Some (Eunop Oneg (Etempvar _x tint) tint)))
...
((___builtin_ais_annot,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_abs, Gfun(Internal f_abs)) :: nil).

Definition public_idents : list ident :=
(_abs :: ___builtin_debug :: ___builtin_nop :: ___builtin_write32_reversed ::
