...
Module Info.
  ...
  Definition source_file := "/Users/Qinxiang/Documents/QinxiangProject/VST-Tutorial/test_null.c"%string.
...
Definition _test_null : ident := 54%positive.

Definition f_test_null := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_p, (tptr tint)) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Sifthenelse (Etempvar _p (tptr tint))
...
((___builtin_bswap64,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_test_null, Gfun(Internal f_test_null)) :: nil).

Definition public_idents : list ident :=
(_test_null :: ___builtin_debug :: ___builtin_nop ::
