...
Module Info.
  ...
  Definition source_file := "/Users/Qinxiang/Documents/QinxiangProject/VST-Tutorial/reverse.c"%string.
...
(Ssequence
  (Sset _w
    (Ecast (Econst_int (Int.repr 0) tint) (tptr (Tstruct _list noattr))))
  (Ssequence
