...
Module Info.
  ...
  Definition source_file := "max3.c"%string.
...
Definition _max3 : ident := 55%positive.
...
Definition f_max3 := {|
  ...
  fn_params := ((_x, tint) :: (_y, tint) :: (_z, tint) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Sifthenelse (Ebinop Olt (Etempvar _x tint) (Etempvar _y tint) tint)
  (Sifthenelse (Ebinop Olt (Etempvar _y tint) (Etempvar _z tint) tint)
    (Sreturn (Some (Etempvar _z tint)))
    (Sreturn (Some (Etempvar _y tint))))
  (Sifthenelse (Ebinop Olt (Etempvar _x tint) (Etempvar _z tint) tint)
    (Sreturn (Some (Etempvar _z tint)))
...
((___builtin_bswap,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_max3, Gfun(Internal f_max3)) :: nil).

Definition public_idents : list ident :=
(_max3 :: ___builtin_debug :: ___builtin_nop ::
